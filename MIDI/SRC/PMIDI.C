...
int vh,vl;
	...
	printf ("Copyright (c) 1993,1994,2015  VESA, Inc. All Rights Reserved.\n");
    printf ("Turbo C++ 3.0 version by Krzysztof Kondrak \n\n");
...
;---|*|
;   \*/
long GetValue (char *s, long orig)
{
long w;
...
long len;
        ...
        if ((rfile = fopen (MIDFileName,"rb")) == NULL) 
        {
...
void far pascal OurMIDIReceiver ( int han, int delta, char mbyte, long filler )
...
;---|*|
;   \*/
void SetSongTempo(long us,int denom)
